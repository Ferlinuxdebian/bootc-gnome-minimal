...
echo "Move o script de p�s instala��o"
mv post-install.sh /usr/bin/post-install.sh

echo "Move o servi�o de p�s instala��o"
mv post-install.service /etc/systemd/system/post-install.service

echo "wget necess�rio para baixar reposit�rios"
dnf5 -y install wget

echo "Configura reposit�rio negativo17 para drivers nvidia"
...
echo "Identifica a vers�o do kernel instalada no container"
...
echo "Desativa alguns servi�os desnecess�rios e habilita outros"
